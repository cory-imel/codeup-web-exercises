...
function checkoutNumber(number) {
...
function isNumber(input) {
    ...
    if (isNaN(number)){
        ...
        var user_input = prompt("Please input your number: ");
        isNumber(user_input);
    } else {
...
function userDialog(){
    ...
    var answer = confirm("Would you enter a number?");
...
function getColor() {
    var users_color = prompt("Please input a color.")
    alert(analyzeColor(users_color));
